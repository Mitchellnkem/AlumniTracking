...
<head>
	...
	<link rel="stylesheet" href="text/css" rel="stylesheet">
</head>
<body>
	<div action="" method="post" autocomplete="on">
		<div class="top_banner">
			<div class="in_banner">
				<div class="logo">
					<img alt="" src="./images/gitb_tech_bridge_launchpad_bridge_2_brainery_logo_design.jpg" width="500" height="300"></div>
			...
			<div class="menu">
				<div class="menu_in">
					<ul>
						...
						<li><lo href="../Registration/Instruction.aspx">Employment Data</lo></li>
			...
			<div class="cleaner"></div>
			<div class="container">
				<h2><span id="lbltitle" style="font-weight:bold;">Please Fill the Form</span></h2>
			</div>
			<div class="mid_box">
            <div class="mid-outer">
                <div class="mid-inner">
...
if (isset($_POST['submit'])){
	// explain this code
	// it will check if the form is submitted and then execute the code inside the if statement
	// the code inside the if statement is empty now, so it will not do anything
	// you can add your code here to process the form data
	...
	$sex = $_POST['sex'];
	$dob = $POST['dob'];
	$religion = $_POST['Religious'];
	$region = $_POST['Region'];	
	$province = $_POST['province'];
	$residence = $_POST['Residence'];


	mysqli_query($conn,"insert into generalinfo (fullname,permanent_address,email_address,telephone_number,civil_status,sex,date_of_birth,religion,region,province,residence) values('$fullname','$padd','$eadd','$telno','$cs','$sex','$dob','$religion','$region','$province','$residence')")or die(mysqli_error($conn));
?>
<script>
