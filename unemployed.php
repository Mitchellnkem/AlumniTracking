...
<body>
	<form method="post" action="" autocomplete="on">
		...
		<div id="menu">
			...
			<div id="menu_in">
				<ul> 
					<li><a href="employed.php<?php echo '?id='.$get_id;
					?>">Employed</a></li>
					<li><a href="employed.php<?php echo '?id='.$get_id;
					?>">Self Employed</a></li>
					<li><a href="employed.php<?php echo '?id='.$get_id;
	...
	<option  value="Family concern and decided no to find a job">Family concern and decided not to find a job</option>
	<option  value="I want to put my own business">I want to put up my own business</option>
		<option  value="I want to be of my own">I want to be on my own</option>
	...
	<option  value="Others">Others</option>
																		...
																		<tr>
                                                                            <td align="right" width="45%">
                                                                             Do you consider CSU and the course you selected as a factor for not being unemployed? :
