...
$queryt = mysqli_query($conn,"select * from selfemployed where fullname = '$get_id'")or die(mysqli_error($conn));																								
$count = mysqli_num_rows($queryt);
	if ($count > 0){
		mysqli_query($conn,"update selfemployed set business = '$business',related = '$related',reasons = '$reasons',noofemployee = '$numberofemployee',skills ='$skills' where fullname = '$get_id'")or die(mysqli_error($conn));
		?>
<script>
...
{
mysqli_query($conn,"insert into selfemployed (fullname,business,related,reasons,noofemployee,skills) values('$get_id','$business','$related','$reasons','$numberofemployee','$skills')")or die(mysqli_error($conn));
