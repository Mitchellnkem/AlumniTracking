								...
								<tbody>
									<tr>
										...
										<td align="left" width="55%">
											<input type="text" name="fullname" maxlength="46" required>
										</td> 
									</tr>
									...
									<tr>
										...
										<td align="left" width="55%">
											<input type="text" name="paddress" maxlength="46" required>
										</td>
									</tr>
									...
									<tr>
                                        ...
                                        <td align="left" width="55%">
											...
											<input name="sex" type="radio" value = "Rather not say" maxlength="46" required>Rather not say &nbsp;
                                        </td>
									</tr>
									...
									<tr>
										...
										<td align="left">
                                            <select name="Religous" required>
												...
												<option value="Iglesia Ni Cristo">Christian</option>
												<option value="Methodist">Methodist</option>
												<option value="Jehovah's Witnesses">Jehovah's Witnesses</option>
												<option value="Born Again Christian">Born Again Christian</option>
												<option value="Born Again Christian">Muslim</option>
